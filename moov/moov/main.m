...
//  moov
//
//  Created by ak on 2019/11/29.
//  Copyright © 2019 有我互动. All rights reserved.
//

#import <Foundation/Foundation.h>

//
// Created by zhaodanny on 2019/11/13.
//
...
int do_faststart(const char* in, const char* out) {
    FILE* infile = NULL;
    FILE* outfile = NULL;
...
int main(int argc, const char * argv[]) {
    ...
    @autoreleasepool {
        ...
        NSLog(@"e.g.\" ./moov inputPath outputPath  \"");
    
        NSLog(@"输入文件路径 %@",[NSString stringWithCString:argv[1] encoding:NSUTF8StringEncoding]);
        
        NSLog(@"输出文件路径 %@",[NSString stringWithCString:argv[2] encoding:NSUTF8StringEncoding]);
        
        do_faststart( argv[1] ,argv[2]);
        
        NSLog(@"使用 less 查看 moov 位置");
    }
    return 0;
}
